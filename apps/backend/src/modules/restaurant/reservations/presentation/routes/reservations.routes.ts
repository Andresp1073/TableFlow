...
router.get(
  ...
  requireAuth,
  enrichContext(),
  requirePermission("restaurants.reservations.read"),
...
router.post(
  ...
  requireAuth,
  enrichContext(),
  requirePermission("restaurants.reservations.create"),
  validate(reservationParamsSchema),
...
router.put(
  ...
  requireAuth,
  enrichContext(),
  requirePermission("restaurants.reservations.update"),
  validate(reservationIdParamsSchema),
...
router.patch(
  ...
  requireAuth,
  enrichContext(),
  requirePermission("restaurants.reservations.cancel"),
  validate(reservationIdParamsSchema),
  controller.cancel,
);
...
router.patch(
  ...
  requireAuth,
  enrichContext(),
  requirePermission("restaurants.reservations.confirm"),
  validate(reservationIdParamsSchema),
  controller.confirm,
);
...
router.patch(
  ...
  requireAuth,
  enrichContext(),
  requirePermission("restaurants.reservations.checkIn"),
  validate(reservationIdParamsSchema),
  controller.checkIn,
);
...
router.patch(
  ...
  requireAuth,
  enrichContext(),
  requirePermission("restaurants.reservations.complete"),
  validate(reservationIdParamsSchema),
  controller.complete,
);
