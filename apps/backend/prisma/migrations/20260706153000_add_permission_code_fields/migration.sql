...
ALTER TABLE `permissions` ADD COLUMN `code` VARCHAR(150) NULL AFTER `id`,
    ADD COLUMN `resource` VARCHAR(100) NULL AFTER `module`,
    ADD COLUMN `action` VARCHAR(100) NULL AFTER `resource`,
    ADD COLUMN `isSystem` BOOLEAN NOT NULL DEFAULT true AFTER `riskLevel`,
    ADD COLUMN `updatedAt` DATETIME(3) NULL AFTER `createdAt`;
