  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">{mode === 'create' ? t('Create Customer') : t('Edit Customer')}</h1>
          <p className="text-sm text-muted-foreground">
            {mode === 'create' ? t('Add a new customer to your restaurant') : t('Update customer information')}
          </p>
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              <Label htmlFor="marketing">{t('Customer consented to marketing communications')}</Label>
            </div>
          </CardContent>
        </Card>
